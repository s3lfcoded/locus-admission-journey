...
export function MatchDetails(){return <details className="match-explainer"><summary>Как читать подборку и Match?</summary><div><b>Три опоры для решения</b><div className="match-factors"><span>01 · Интересы и программа</span><span>02 · Баллы и требования</span><span>03 · Бюджет и страна</span></div><p>В этой версии показан учебный сценарий Computer Science: три заранее подготовленных вуза и демонстрационные оценки Match. Анкета обновляет диагностику, но не пересчитывает подборку. Процент Match не означает вероятность зачисления.</p></div></details>}
